    ...
    useEffect(() => {
        if (hash) {
            ...
            if (element) {
                ...
                // Se o elemento ainda não existe (devido a lazy loading), espera um pouco
                setTimeout(() => {
...
function AppContent() {
    ...
    // Any path that isn't the root is considered a city/sub page
    const isCityPage = location.pathname !== '/';
    ...
    return (
        <div className={`app-container ${isCityPage ? 'city-page-active' : ''}`}>
            ...
            <AnimatePresence>
                {isMenuOpen && (
                    ...
                    >
                        ...
                        <Link to="/#marcas" onClick={() => setIsMenuOpen(false)}>{t('mobileMenu.brands')}</Link>
            ...
            <footer className="footer-dark">
                <div className="container footer-grid-dark">
                    <div className="footer-brand">
                        ...
                        <img src={companyLogo} alt="Locksmith Service" className="footer-brand-img" />
                    </div>
