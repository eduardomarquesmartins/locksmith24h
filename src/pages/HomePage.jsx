...
import { Phone, Car, Clock, Shield, MapPin, CheckCircle2, Menu, X, Key, Video, Radio, AlertTriangle, Lock, Facebook, Instagram, Mail, ChevronDown, ChevronUp, ExternalLink } from 'lucide-react'
...
import { CITIES, slugify, getAutoKeyPath } from '@shared/constants/cities'
...
const HomePage = ({ t, i18n, openLegal }) => {
    ...
    return (
        <>
                        ...
                        <div className="hero-text">
                            ...
                            >
                                <motion.span
                                    ...
                                    style={{ color: '#ffdd00', fontWeight: '500', fontSize: '1.2rem', display: 'block', marginBottom: '1.5rem' }}
                                >
                    ...
                    <div className="areas-split-layout">
                        ...
                        <div className="areas-content-right">
                            ...
                            <div className="areas-grid-compact">
                                        ...
                                        >
                                            {hasNeighborhoods ? (
                                                <div className={`area-pill-compact ${isOpen ? 'is-open' : ''}`} style={{ display: 'flex', alignItems: 'center', pointerEvents: 'auto' }}>
                                                    <Link 
                                                        to={getAutoKeyPath(name) || `/cerrajero-${slugify(name)}`} 
                                                        style={{ color: 'inherit', textShadow: 'none', border: 'none', background: 'none', flex: 1, padding: '0px', textAlign: 'left', fontWeight: '500' }}
                                                    >
                                                        {name}
                                                    </Link>
                                                    <div
                                                ...
                                                <Link to={getAutoKeyPath(name) || `/cerrajero-${slugify(name)}`} className="area-pill-compact">
                                                    {name}
                                                </Link>
                                            )}
                                                    ...
                                                    >
                                                        ...
                                                        <div className="dropdown-content">
                                                            {neighborhoods.map((n, i) => (
                                                                <Link
                                                                    key={i}
                                                                    to={getAutoKeyPath(name) ? `${getAutoKeyPath(name)}?barrio=${encodeURIComponent(n)}` : `/cerrajero-${slugify(name)}?barrio=${encodeURIComponent(n)}`}
                                ...
                                <Link to="/llaves-coche-torrevieja-orihuela-costa" className="area-pill-compact" style={{ background: 'var(--brand-yellow)', color: '#000', fontWeight: '800' }}>
                                    {t('auto_keys_landing.city_link_label')}
                                </Link>
                            </div>
                        </div>
                    </div>
            ...
            <section className="partner-site-banner">
                <div className="container">
                    <motion.div 
                    ...
                    >
                        <span className="sub-tag">{t('external_site.title')}</span>
                        <h2>{t('external_site.title')}</h2>
                        <p>{t('external_site.text')}</p>
                        <motion.a 
                            ...
                            whileTap={{ scale: 0.95 }}
                        >
                            <span>{t('external_site.link_text')}</span>
