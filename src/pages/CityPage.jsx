...
import { Phone, Clock, Shield, CheckCircle2, ChevronRight, MapPin, Key, Lock, Home, Car, ChevronDown, ChevronUp, Map } from 'lucide-react';
import { useTranslation, Trans } from 'react-i18next';
import { getCityNameFromSlug } from '../constants/cities';
...
const CityPage = () => {
    ...
    useEffect(() => {
        window.scrollTo(0, 0);
        document.title = t('city_page.title', { city: cityWithProvince });
    }, [cityWithProvince, t]);
    ...
    return (
        <div className="city-page-content">
            ...
            >
                <div className="container">
                    ...
                    >
                        ...
                        <h1>{t('city_page.title', { city: cityWithProvince })}</h1>

                        <div className="city-hero-actions">
                            <a href="tel:+34602659054" className="btn-primary">
                                <Phone size={20} /> {t('city_page.call_btn')}
                            </a>
                            <a href="https://wa.me/34602659054" className="btn-secondary">
                ...
                <div className="city-grid">
                    <div className="city-main-text">
                        <div className="content-block intro-narrative">
                            <h2 className="city-section-title">
                                {t('city_page.intro_title', { city: cityName })}
                            </h2>

                            <p className="lead-text">{t('city_page.intro_text', { city: cityWithProvince })}</p>
                        </div>
                    ...
                    <div className="city-sidebar">
                        <div className="sidebar-card">
                            <h3><Shield size={22} className="text-green" /> {t('city_page.why_us')}</h3>
            ...
            <section className="city-solutions bg-dark">
                <div className="container">
                    ...
                    <div className="solutions-list-grid mt-12">
                        ...
                        <div className="sol-item">
                            <div className="sol-icon"><Home size={32} /></div>
            ...
            <section className="special-faq container">
                ...
                <div className="faq-section">
                    ...
                    <div className="faq-item-premium bg-gray-50 p-8 rounded-2xl border border-gray-100">
                        <h3 className="text-xl font-semibold mb-4 text-gray-900">{t('city_page.faq_q1', { city: cityName })}</h3>
                        <p className="text-gray-600 leading-relaxed">{t('city_page.faq_a1', { city: cityName })}</p>
                    </div>
                </div>
            </section>

            {/* Final CTA Section */}
            <section className="city-final-cta container pb-16">
                <div className="final-cta-box bg-dark p-10 md:p-16 rounded-3xl border border-white/10 text-center shadow-2xl">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold text-white mb-8">
                        {t('city_page.intro_title', { city: cityName })} 24h
                    </h2>
            ...
            <section className="city-internal-links container pt-0 pb-20">
                <div className="links-box p-10 rounded-3xl bg-white shadow-xl border border-gray-100">
                    <p className="text-gray-700 text-lg">
                        <Trans i18nKey="city_page.internal_link1" values={{ province, city: cityName }}>
                            <Link to="/" className="text-green font-bold hover:underline">text</Link>
                        </Trans>
                    </p>
                    <div className="h-px bg-gray-100 my-8" />
                    <p className="text-gray-700 text-lg">
                        <Trans i18nKey="city_page.internal_link2">
                            <Link to="/" className="text-green font-bold hover:underline">página principal</Link>
                        </Trans>
                    </p>
                </div>
            </section>
